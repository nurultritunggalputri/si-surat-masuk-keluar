<?php
$id=$_GET['id'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tb_surat_masuk WHERE id ='$id'") or die ("SQL Edit error");
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE tb_surat_masuk SET no_surat='$no_surat', asal_surat='$asal_surat', tgl_surat='$tglsurat', tgl_masuk='$tglmasuk', penerima='$penerima',
