        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Surat Masuk</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
									...
									<td><?= $data['perihal'] ?></td>
                                    <td>
                                        <a href="report/laporan_masuk_satu.php?id=<?= $data['id'] ?>" target="_blank" class="btn btn-info btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/laporan_masuk_semua.php" target="_blank" class="btn btn-info btn-sm">
                                        <span class="fa fa_print"></span> Cetak Semua Surat Masuk
...
<div id="cetak_perbulan" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/laporan_masuk_perbulan.php" method="post">
        <h4>Pilih bulan </h4>
...
<div id="cetak_pertahun" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/laporan_masuk_pertahun.php" method="post">
        <h4>Pilih tahun</h4>
        <select name="tahun" class="form-control">
          <?
            for ($i=substr(date("d-m-Y"),6,4); $i > substr(date("d-m-Y"),6,4)-5; $i--) { ?>
