...
<html>
    <head>
        <title>Cetak Data Surat Keluar Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <hr>
                        <h3>DATA SURAT KELUAR PERBULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tb_surat_keluar WHERE substr(tgl_pinjam,1,7)='$ambilthn-$ambilbln'";
