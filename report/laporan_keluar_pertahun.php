...
<html>
    <head>
        <title>Cetak Data Surat Keluar Pertahun</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA SURAT KELUAR TAHUN   <? echo "$ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tb_surat_keluar WHERE substr(tgl_pinjam,1,4)='$ambilthn'";
